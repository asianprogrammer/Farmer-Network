...
export default function ProfileForm({
  ...
  const { fullName = "", username = "", bio = "", phone = "", address = "" } = values;
      ...
      <form className="form-section" onSubmit={onSubmit}>
        <div className="form-stack">
          ...
          <div className="form-row">
            <label className="label"><UserIcon /> Full Name</label>
            <input
              className="input"
              name="fullName"
          ...
          <div className="form-row">
            <label className="label"><UserIcon /> Username</label>
            <input
              className="input"
              name="username"
              required
          ...
          <div className="form-row">
            <label className="label"><GlobeIcon /> Bio</label>
            <textarea
              className="textarea"
              name="bio"
              rows={4}
          ...
          <div className="form-row">
            <label className="label"><PhoneIcon /> Phone Number</label>
            <input
              className="input"
              name="phone"
          ...
          <div className="form-row">
            <label className="label"><MapPinIcon /> Address/Location</label>
            <input
              className="input"
              name="address"
