  ...
  return (
    <section className="card">
      <div className="section-title">
        <LockIcon className="icon" style={{ color: "var(--danger)" }} />
        Change Password
      </div>
      ...
      <form className="form-section" onSubmit={onSubmit}>
        <div className="form-stack">
          ...
          <div className="form-row input-icon">
            <label className="label"><LockIcon /> Current Password</label>
            <input
          ...
          <div className="form-row input-icon">
            <label className="label"><LockIcon /> New Password</label>
            <input
          ...
          <div className="form-row input-icon">
            <label className="label"><LockIcon /> Confirm New Password</label>
            <input
